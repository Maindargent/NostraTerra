...
let events: [Event] = [
    Event(startedAt: Calendar.current.date(from: DateComponents(year: 2025, month: 5, day: 12))!, endAt: Calendar.current.date(from: DateComponents(year: 2025, month: 5, day: 13))!, image: "https://picsum.photos/seed/music1/800/600", title: "Balade nocturne", description: "compte médiévale sous forme de balade nocturne dans l'enceinture du chateau de Mont Miraille", created_at: Calendar.current.date(from: DateComponents(year: 2025, month: 5, day: 12))!, activity: .artVisuel, region: "Provence", author: User(lastName: "Martin", firstName: "Lucas", birthDate: Calendar.current.date(from: DateComponents(year: 2025, month: 5, day: 12))!, description: "Bonjour, moi c'est Lucas", profilPicture: URL(string: "https://picsum.photos/seed/music1/800/600")!), geoPoint: CLLocationCoordinate2D(latitude: 23.3, longitude: 23.3), likeCount: 22)
]
//let events: [Event] = [
//    Event(startedAt: date.formatted(.dateTime.day().month().year()), endAt: <#T##Date#>, image: <#T##String#>, title: <#T##String#>, description: <#T##AttributedString#>, created_at: <#T##Date#>, activity: <#T##PublicationType#>, region: <#T##String#>, author: <#T##User#>, geoPoint: <#T##CLLocationCoordinate2D#>, likeCount: <#T##Int#>)
//    ]
